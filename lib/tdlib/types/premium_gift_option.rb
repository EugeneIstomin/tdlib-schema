module TD::Types
  ...
  # @attr discount_percentage [Integer] The discount associated with this gift option, as a percentage.
  ...
  # @attr payment_link [TD::Types::InternalLinkType, nil] An internal link to be opened for gifting Telegram Premium to
  #   the user if store payment isn't possible; may be null if direct payment isn't available.
  class PremiumGiftOption < Base
