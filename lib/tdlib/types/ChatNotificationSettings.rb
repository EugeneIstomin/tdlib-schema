module TD::Types
  ...
  #   chat or the forum chat is used instead.
  ...
  #   ignored and the value for the relevant type of chat or the forum chat is used instead.
  ...
  #   value for the relevant type of chat or the forum chat is used instead.
