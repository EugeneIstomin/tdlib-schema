module TD::Types
  ...
  # @attr premium_gift_options [Array<TD::Types::PremiumGiftOption>] The list of available options for gifting Telegram
  #   Premium to the user.
  ...
  class UserFullInfo < Base
    ...
    attribute :premium_gift_options, TD::Types::Array.of(TD::Types::PremiumGiftOption)
